                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                <img src="<?php echo e(assets_url('images/logo.png')); ?>" class=" p-5 img-fluid" alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
...
</html><?php /**PATH C:\xampp7.3\htdocs\gmi\application\views/admin/login.blade.php ENDPATH**/ ?>