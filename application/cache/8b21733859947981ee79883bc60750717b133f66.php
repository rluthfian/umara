...
<?php $__env->startSection('title', 'Data Arsip | Admin'); ?>
...
<div class="container-fluid">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <div>
                                    <button class="btn btn-primary" onclick="modalEditArsip('<?php echo e($value->id_arsip); ?>')">Edit</button>
                                    <button class="btn btn-danger" onclick="hapusArsip('<?php echo e($value->id_arsip); ?>')">Delete</button>
                                </div>
                            </td>
                        </tr>
    ...
    <script>
        function addArsip() {
            ...
            $.ajax({
                url: "<?php echo e(base_url('admin/arsip/addArsip')); ?>",
                type: "POST",
    ...
    <script>
        function modalEditArsip(id) {
            $.ajax({
                url: "<?php echo e(base_url('admin/arsip/editArsip/')); ?>" + id,
                type: "GET",
                success: function(response) {
                    ...
                    if (foto) {
                        $("#existingPhoto").attr("src", "<?php echo e(assets_url('images/arsip/')); ?>" + foto);
    ...
    <script>
        function updateArsip(id) {
            ...
            $.ajax({
                url: "<?php echo e(base_url('admin/arsip/updateArsip/')); ?>" + id,
                type: "POST",
                data: formData,
                dataType: 'json',
                contentType: false, // Set contentType to false when using FormData
    ...
    <script>
        function hapusArsip(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?php echo e(base_url('admin/arsip/deleteArsip/')); ?>" + id,
                        type: "POST",
                        dataType: 'json',
                        success: function(response) {
                            if (response.status === 'success') {
...
<?php echo $__env->make('admin/layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.3\htdocs\chevalier\application\views/admin/arsip/index.blade.php ENDPATH**/ ?>