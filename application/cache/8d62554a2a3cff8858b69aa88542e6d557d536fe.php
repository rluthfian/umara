          ...
          <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="<?php echo e(assets_url('images/undraw_profile_1.svg')); ?>" alt="...">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="<?php echo e(assets_url('images/undraw_profile_2.svg')); ?>" alt="...">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="<?php echo e(assets_url('images/undraw_profile_3.svg')); ?>" alt="...">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small text-capitalize"><?php echo e($username); ?></span>
                <img class="img-profile rounded-circle" src="<?php echo e(assets_url('images/undraw_profile.svg')); ?>">
              </a>
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="<?php echo e(base_url('auth/logout')); ?>" data-toggle="modal" data-target="#logoutModal">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="mt-4 text-center small">
                    <span class="mr-2">
                      <i class="fas fa-circle text-primary"></i> Edukasi
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-success"></i> Berita
                    </span>
                    <span class="mr-2">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="<?php echo e(assets_url('images/undraw_posting_photo.svg')); ?>" alt="...">
                  </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo e(base_url('auth/logout')); ?>">Logout</a>
        </div>
      </div>
    </div>
  </div>
...
</html><?php /**PATH C:\xampp7.3\htdocs\gmi\application\views/admin/product/index.blade.php ENDPATH**/ ?>