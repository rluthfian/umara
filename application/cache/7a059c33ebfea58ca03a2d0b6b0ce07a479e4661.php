...
<style>
  ...
  .gradient-custom-2 {
    ...
    background: linear-gradient(to right, #C39D27, #F8CE2C, #F8CE2C, #C39D27);
  }

  #hero {
    /* background: linear-gradient(180deg, #C39D27 0%, #9C7E1F 30.73%, #755E17 100%); */
    background-image: url("<?php echo e(assets_url('images/heroBanner.jpg')); ?>");
    background-size: 100% 100%;
  ...
  .btn-custom-primary:hover {
    border-radius: 8px;
    background: linear-gradient(180deg, #444445 0%, #131313 100%),
      linear-gradient(0deg, #44494C, #44494C);
    color: #FFFFFF;
  }
...
</style><?php /**PATH C:\xampp7.3\htdocs\gmi\application\views/layouts/head.blade.php ENDPATH**/ ?>