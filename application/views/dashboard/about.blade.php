            ...
            <div class="col-12 col-lg-9">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <img src="https://umaramultibisnis.com/wp-content/uploads/2023/03/Logo-ASOHI.png" class="img-fluid px-lg-5 px-0" alt="">
                        </div>
    ...
    <div class="container-fluid" style="background-color:#073068 !important">
        <div class="row justify-content-center">
            <div class="col-9 justify-content-center">
                <div class="row">
                    <div class="col-12 col-lg-6 py-3 text-white">
