<link rel="stylesheet" href="{{assets_url('css/bootstrap5.min.css')}}">
...
<style>
  ...
  #layanan_kami {
    background-image: url("{{assets_url('images/heroBanner.jpg')}}");
  ...
  #hero {
    position: relative;
    background-image: url("{{assets_url('images/background.jpg')}}");
    background-size: 100% 100%;
  }
  #dosen-hero{
    position: relative;
    background-image: url("{{assets_url('images/dosen_bg.jpg')}}");
    background-size: 100% 100%;
  }
